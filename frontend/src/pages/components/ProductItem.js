...
const ProductItem = (props) => {
  ...
  return (
    <Fragment>
      <div className="h-full flex flex-col justify-between border shadow-md">
        ...
        <div className="px-2 pb-2 flex justify-between items-center mt-4">
          ...
          <button
            ...
            className="bg-slate-950 p-2 text-white rounded-md text-tb lg:text-xb lg:hover:bg-blue-600 shadow-lg"
          >
            Add To Cart
          </button>
        </div>
