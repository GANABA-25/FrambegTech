              ...
              <div className="max-[767px]:w-[18rem] grid max-[767px]:gap-6 md:gap-12 lg:gap-6 lg:w-[30rem]">
                ...
                <div className="relative grid max-[767px]:gap-2 md:gap-4 items-center">
                  ...
                  <div
                    ...
                    className="absolute z-[1005] opacity-50 hover:opacity-100 right-4 max-[767px]:bottom-3 cursor-pointer md:bottom-4 flex items-center text-blue-600 lg:bottom-3"
                  >
                    {viewPassword ? (
