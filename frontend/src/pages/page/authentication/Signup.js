              ...
              <div className="max-[767px]:w-[20rem] grid max-[767px]:gap-8 md:gap-10 lg:w-[25rem] lg:gap-4">
                ...
                <div className="relative grid gap-1 md:gap-2 lg:gap-1">
                  ...
                  <div
                    ...
                    className="opacity-50 hover:opacity-100 absolute z-[1005] right-4 max-[767px]:bottom-3 cursor-pointer md:bottom-4 flex items-center text-blue-600 lg:bottom-3"
                  >
                    {viewPassword ? (
