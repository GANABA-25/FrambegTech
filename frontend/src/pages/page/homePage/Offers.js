...
const Offers = () => {
  return (
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-4 shadow-md border-2 gap-4 bg-white m-4 p-4 md:absolute md:top-46 lg:w-4/5 lg:m-auto lg:top-[43rem]  lg:right-0 lg:left-0">
